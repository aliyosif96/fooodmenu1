...
/*
          saveMediaRecipes =
            '<article class="card saved-recipes-card media">' +
            '<figure class="media-left">' +
            '<p class="image is-64x64">' +
            '<img src="' +
            savedRecipesArr[i].image +
            '">' +
            "</p>" +
            "</figure>" +
            ...
            "<p>" +
            "<strong>" +
            savedRecipesArr[i].title +
            "</strong> <small>" +
            savedRecipesArr[i].caloriesPer +
            " calories per serving. </small>" +
            "<small>Servings: " +
            savedRecipesArr[i].servings +
            "</small>" +
            "<br>" +
            "" +
            "</p>" +
            ...
            '<a class="level-item button is-primary card-footer-item show-recipe-modal plannerBtn" data-id=' +
            i +
            ">Add to Planner</a>" +
            '<a class="level-item button is-primary is-outlined card-footer-item recipe-link" target="_blank" href="' +
            savedRecipesArr[i].url +
            '"data-id=' +
            i +
            ">Get the Recipe</a>" +
            "</div>" +
            ...
            '<button class="remove-saved-recipes delete" data-id=' +
            i +
            "></button>" +
            "</div>" +
            "</article>";
